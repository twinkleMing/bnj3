...
public class Graph
{
	 ...
	 * \param[in] enum_replace
	 * \return the vertex
	 */
	public Vertex get(int enum_replace)
	{
		if (0 <= enum_replace && enum_replace < _VertexCount)
		{
			Vertex T = _VertexStore[enum_replace].v();
			return T;
		}
		return null;
	}
	 ...
	 */
	public boolean end(int enum_replace)
	{
		return enum_replace < _VertexCount && enum_replace >= 0;
	}
